...
# TODO: Implement similarly to https://gist.github.com/kdubovikov/eb2a4c3ecadd5295f68c126542e59f0a
...
# Set data loader
Data_loader_name = gray.train_loader
# Set batch size
batch_size = gray.batch_size_custom
